...
class Admin {
    ...
    private static function checkReferer(){
        ...
        $host = $url['host'];
        if( self::isMySite() && false === stripos( $host, 'saltydog.com') ){
            die('JQuery Form error: can not directly access form admin panel on saltydog.com');
        };
    }
...
?>
        ...
        <a href="<?php echo $editFormUrl; ?>"  onclick="document.frmJQueryForm.submit(); return false;" title="Edit your form on saltydog.com">edit</a>
<?php
} // if
?>
...
<?php
   ...
   private static function sendVerificationCode(){
    ...
    private static function validateForm(){
        ...
        header('Location:https://www.saltydog.com/sales_reports_bkup/thankyou.html ');
...
<head>
  ...
  <title>Form Admin Panel | Generated by saltydog.com</title>
...
?>
    ...
    <footer class="footer">
      <div class="container">
        <p class="text-muted">Generated by <a href="http://www.saltydog.com" target="_blank">saltydog.com</a></p>
      </div>
    </footer>
